...
- **Techniques:** Exploratory Data Analysis (EDA), Correlation Matrix, Seasonal Trend Analysis.
- **Key Insight:** Identified a 30% higher cancellation rate in the "Transient" market segment, proposing a dynamic deposit policy.

### 2. Financial Loan Modeling
**Objective:** Predict personal loan uptake to improve marketing conversion.
